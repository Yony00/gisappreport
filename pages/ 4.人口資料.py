...
tainan_pop[['老幼人數比例']].plot(kind='bar', color='lightgreen', ax=ax, legend=False)
...
tainan_pop[['獨居老人人數']].plot(kind='bar', color='lightblue', ax=ax, legend=False)
ax.legend(prop=font, fontsize=8)
plt.xlabel("行政區", fontproperties=font, fontsize=8)
...
tainan_pop[['低收入戶戶內人數']].plot(kind='bar', color='lightpink', ax=ax, legend=False)
ax.legend(prop=font, fontsize=8)
plt.xlabel("行政區", fontproperties=font, fontsize=8)
plt.ylabel("人數", fontproperties=font, fontsize=8)
plt.xticks(fontproperties=font, fontsize=8, rotation=45)
